...
//  adds or updates modules in a course using new formslib
    ...
    //echo $CFG->wwwroot.'/course/lib.php';
    ...
    $insertdb      = optional_param('insertdb',0,PARAM_ALPHA);
    $moduleidd     = optional_param('pblid',0,PARAM_INT);
    //$moduleidd = 90;
    ...
    if ($mform->is_cancelled()) {
        ...
        /*echo ".....................................................**";
        echo $fromform->pblidd; echo '<br/>';
        echo $fromform->coursemodule; echo '<br/>';
        echo $fromform->section      ;   echo '<br/>';
        echo $fromform->visible       ;  echo '<br/>';
        echo $fromform->cmidnumber     ; echo '<br/>';
        echo $fromform->groupmode       ; echo '<br/>';
        echo $fromform->groupingid       ; echo '<br/>';
        echo $fromform->groupmembersonly ;echo '<br/>';
        echo $fromform->course           ;echo '<br/>';
        echo $fromform->module           ;echo '<br/>';
        echo $fromform->modulename       ;echo '<br/>';
        echo $fromform->instance         ;echo '<br/>';
        echo $fromform->return           ;echo '<br/>';
        echo $fromform->update           ;echo '<br/>';
        echo $form->coursemodule; echo '<br/>';
        echo $form->section      ;   echo '<br/>';
        echo $form->visible       ;  echo '<br/>';
        echo $form->cmidnumber     ; echo '<br/>';
        echo $form->groupmode       ; echo '<br/>';
        echo $form->groupingid       ; echo '<br/>';
        echo $form->groupmembersonly ;echo '<br/>';
        echo $form->course           ;echo '<br/>';
        echo $form->module           ;echo '<br/>';
        echo $form->modulename       ;echo '<br/>';
        echo $form->instance         ;echo '<br/>';
        echo $form->return           ;echo '<br/>';
        echo $form->update           ;echo '<br/>';
        echo "**.....................................................";*/
        ...
        /*if($moduleidd!=0)
        {
            $fromform->moduleidd=$moduleidd;
            echo "__________________________yyyyyyyyyyyyyyyy__________";
        }
        echo $fromform->modulename;
        echo "DDDDDDDDDDDDDDDDDDDDDDDDDDDDdddd";*/
        //echo $fromform->moduleidd;
        ...
        if (isset($fromform->submitbutton)) {
            $select_table=0;
            $max_section=get_record('course','id',$fromform->course);
            if($max_section->numsections%2!=0) {
                $max_section->numsections=$max_section->numsections-1;
            }
            if($fromform->section%2!=0){
                $fromform->section=$fromform->section-1;
                $select_table=1;
            }

            $pbl_section=$fromform->section-($max_section->numsections+10);
            $pbl_id=$pbl_section/2;
            if($select_table==0) {
                update_pbl_forum($fromform->course,$pbl_id);
            }
            else if ($select_table==1) {
                update_pbl_discuss($fromform->course,$pbl_id,$type_of_discuss,$USER->id,$moduletype);
            }
            else {
                error ("Error in the name of the pbl table u want to update");
            }
