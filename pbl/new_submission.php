...
$assessment_type = optional_param('assessmenttype', 0, PARAM_ALPHA);
if ($id) {
...
$url=$CFG->wwwroot.'/mod/pbl/modedit.php?add='.$type.'&type='.$assessment_type.'&course='.$COURSE->id.'&section='.$pbl_section.'&return=0&insertdb=pbl_discuss';
		redirect($url);
?>
